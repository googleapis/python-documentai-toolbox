...
setuptools.setup(
    ...
    install_requires=(
        ...
        "google-api-core >= 2.15.0, <3.0.0dev,!=2.0.*,!=2.1.*,!=2.2.*,!=2.3.0; python_version>='3.12'",
        "pandas >= 1.0.0, <3.0.0",
        "pandas >= 1.0.0, <2.0.0; python_version<'3.8'",
        "tabulate >= 0.9.0, <1.0.0",
        "proto-plus >= 1.22.0, <2.0.0dev",
        "proto-plus >= 1.22.2, <2.0.0dev; python_version>='3.11'",
        "proto-plus >= 1.22.3, <2.0.0dev; python_version>='3.12'",
        "grpc-google-iam-v1 >= 0.12.6, < 0.14dev",
        "grpc-google-iam-v1 >= 0.13.0, < 0.14dev; python_version>='3.12'",
        "google-cloud-bigquery >= 3.5.0, < 4.0.0dev",
        "google-cloud-bigquery >= 3.14.0, < 4.0.0dev; python_version>='3.12'",

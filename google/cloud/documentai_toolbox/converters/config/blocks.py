...
class Block:
    ...
    Attributes:
        ...
        page_number:
            Optional.
    """
    bounding_box: dataclasses.field(init=True, repr=False, default="")
    block_references: dataclasses.field(init=False, repr=False, default="")
    block_id: dataclasses.field(init=False, repr=False, default="")
    confidence: dataclasses.field(init=False, repr=False, default="")
    type_: dataclasses.field(init=True, repr=False, default="")
    text: dataclasses.field(init=True, repr=False, default="")
    page_number: dataclasses.field(init=False, repr=False, default="")
    page_width: dataclasses.field(init=False, repr=False, default="")
    page_height: dataclasses.field(init=False, repr=False, default="")
    bounding_width: dataclasses.field(init=False, repr=False, default="")
    bounding_height: dataclasses.field(init=False, repr=False, default="")
    bounding_type: dataclasses.field(init=False, repr=False, default="")
    bounding_unit: dataclasses.field(init=False, repr=False, default="")
    bounding_x: dataclasses.field(init=False, repr=False, default="")
    bounding_y: dataclasses.field(init=False, repr=False, default="")
    docproto_width: dataclasses.field(init=False, repr=False, default="")
    docproto_height: dataclasses.field(init=False, repr=False, default="")

...
from google.cloud.documentai_toolbox.converters.custom.bbox_conversion import (
    _convert_bbox_to_docproto_bbox,
    _get_text_anchor_in_bbox,
)
from google.cloud.documentai_toolbox.converters.custom.blocks import (
    Block,
    _load_blocks,
)
...
def _convert_to_docproto_with_custom_function(
    ...
    try:
        ...
        if retry_number == 6:
            ...
            return _convert_to_docproto_with_custom_function(
                name=name,
...
def _get_docproto_files(
    ...
    for future in f:
        blobs = future.result()
        docproto = _convert_to_docproto_with_custom_function(
...
def _convert_with_custom_functions(
    gcs_input_path: str,
    gcs_output_path: str,
    project_id: str,
    location: str,
